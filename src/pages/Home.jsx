...
const Home = () => {
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-600 via-blue-700 to-indigo-800">
      ...
      <div className="relative overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-20 pb-24">
          ...
          <div className="max-w-4xl mx-auto">
            <div className="bg-gradient-to-br from-purple-900 to-indigo-900 rounded-2xl shadow-2xl overflow-hidden border border-purple-500 border-opacity-30">
      ...
      {/* Activities Section */}
      <div className="bg-gradient-to-b from-blue-50 via-indigo-50 to-purple-50 py-16">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="group relative">
              <div className="border-2 border-blue-200 flex flex-col p-5 relative bg-white/90 backdrop-blur-sm rounded-xl hover:border-blue-500 hover:shadow-2xl transition-all duration-300">
                <Icon className="absolute h-5 w-5 -top-2.5 -left-2.5 text-blue-600" />
                <Icon className="absolute h-5 w-5 -bottom-2.5 -left-2.5 text-blue-600" />
                <Icon className="absolute h-5 w-5 -top-2.5 -right-2.5 text-blue-600" />
                <Icon className="absolute h-5 w-5 -bottom-2.5 -right-2.5 text-blue-600" />
                ...
                <div className="flex-1 flex flex-col">
                  ...
                  <div className="flex flex-wrap gap-2">
                    ...
                    <span className="text-xs px-3 py-1 rounded-full bg-indigo-100 text-indigo-700 border border-indigo-300 font-medium">
                      Teamwork
                    </span>
                  </div>
                </div>
            ...
            <div className="group relative">
              <div className="border-2 border-purple-200 flex flex-col p-5 relative bg-white/90 backdrop-blur-sm rounded-xl hover:border-purple-500 hover:shadow-2xl transition-all duration-300">
                <Icon className="absolute h-5 w-5 -top-2.5 -left-2.5 text-purple-600" />
                <Icon className="absolute h-5 w-5 -bottom-2.5 -left-2.5 text-purple-600" />
                <Icon className="absolute h-5 w-5 -top-2.5 -right-2.5 text-purple-600" />
                <Icon className="absolute h-5 w-5 -bottom-2.5 -right-2.5 text-purple-600" />
                ...
                <div className="flex-1 flex flex-col">
                  ...
                  <div className="flex flex-wrap gap-2">
                    ...
                    <span className="text-xs px-3 py-1 rounded-full bg-pink-100 text-pink-700 border border-pink-300 font-medium">
                      Analysis
                    </span>
                  </div>
                </div>
            ...
            <div className="group relative">
              <div className="border-2 border-green-200 flex flex-col p-5 relative bg-white/90 backdrop-blur-sm rounded-xl hover:border-green-500 hover:shadow-2xl transition-all duration-300">
                <Icon className="absolute h-5 w-5 -top-2.5 -left-2.5 text-green-600" />
                <Icon className="absolute h-5 w-5 -bottom-2.5 -left-2.5 text-green-600" />
                <Icon className="absolute h-5 w-5 -top-2.5 -right-2.5 text-green-600" />
                <Icon className="absolute h-5 w-5 -bottom-2.5 -right-2.5 text-green-600" />
                ...
                <div className="flex-1 flex flex-col">
                  ...
                  <div className="flex flex-wrap gap-2">
                    ...
                    <span className="text-xs px-3 py-1 rounded-full bg-teal-100 text-teal-700 border border-teal-300 font-medium">
                      Resilience
                    </span>
                  </div>
                </div>
