...
const EnhancedQuizBuilder = () => {
  ...
  const addQuestion = () => {
    const newQuestion = {
      ...
      options: [
        { text: '', correctRank: 1, marks: 10 }, // Each option has its own marks
        { text: '', correctRank: 2, marks: 8 },
        { text: '', correctRank: 3, marks: 6 },
        { text: '', correctRank: 4, marks: 4 }
      ],
    ...
    setQuizData(prev => ({
      ...
      questions: prev.questions.map(q =>
        q.id === questionId
          ? {
              ...q,
              options: [...q.options, { text: '', correctRank: q.options.length + 1, marks: 5 }]
            }
          : q
      )
    }));
