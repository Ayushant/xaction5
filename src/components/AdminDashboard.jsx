                    ...
                    <tr key={score._id || score.id} className="hover:bg-gray-50">
                      ...
                      <td className="px-6 py-4 whitespace-nowrap">
                        <span className={`px-2 py-1 text-xs font-semibold rounded-full ${
                          score.totalScore >= 80 ? 'bg-green-100 text-green-800' :
                          score.totalScore >= 60 ? 'bg-yellow-100 text-yellow-800' :
              ...
              <div className="mb-6 p-4 bg-gradient-to-r from-blue-50 to-indigo-50 rounded-lg border border-blue-200">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  ...
                  <div className="text-center bg-white rounded-lg p-3 border-2 border-blue-300">
                    ...
                    <p className="text-3xl font-bold text-blue-600">{Math.round(selectedScore.totalScore)}%</p>
                    <button
                      onClick={() => {
